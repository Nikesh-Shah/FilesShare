    ...
    <div>
      ...
      <section className="max-w-4xl mx-auto mb-8 py-12 px-4">
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8 text-center">
          <h1 className="text-4xl font-bold text-blue-900 mb-2">About TabShare</h1>
          <h2 className="text-xl font-semibold text-blue-700 mb-4">Ultra-fast, Private, Peer-to-Peer File Sharing</h2>
          <p className="text-lg text-gray-700 mb-6">Welcome to TabShare, your secure and instant solution for sending files directly between devices—no cloud, no waiting, no compromise.</p>
          <p className="text-md text-gray-600 mb-2">Our mission is to make file transfer effortless, private, and accessible for everyone. Whether you're sharing photos, documents, or large videos, TabShare is built for speed, privacy, and simplicity.</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow p-8 mb-10">
          <h2 className="text-2xl font-bold text-blue-900 mb-4">Why Choose TabShare?</h2>
        ...
        <div className="bg-blue-50 rounded-xl shadow p-8 mb-10">
          <h2 className="text-2xl font-bold text-blue-900 mb-4">How TabShare Works</h2>
          ...
          <div className="flex justify-center mt-8">
            <img src="/work.png" alt="How TabShare Works" className="rounded-lg shadow-lg max-w-full h-auto" />
          </div>
        ...
        <div className="bg-white rounded-xl shadow p-8 mb-10 flex flex-col md:flex-row items-center justify-between">
          <div className="mb-6 md:mb-0">
            ...
            <p className="text-gray-700 mb-2">TabShare is built with React, Vite, WebRTC, Socket.IO, Node.js, Express, and MongoDB for speed, privacy, and reliability.</p>
